...
const AdminLoginForm: React.FC = () => {
    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Welcome to the NyayChain Administrative Dashboard.",
        });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50/30 to-slate-100 p-4 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-grid-slate-200 bg-[bottom_1px_center] dark:bg-grid-slate-700/25 mask-image-gradient"></div>
